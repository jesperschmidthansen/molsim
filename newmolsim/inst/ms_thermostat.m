...
classdef ms_thermostat < handle
	...
	methods 
		...
		function this = ms_thermostat(tauQ=10.0)
			this.tauQ = tauQ;
			this.xi = 0.01;
			this.ntypes = -1;
		end
		...
		function relaxttemp(this, atoms, atype, temperature, tauQ=0.01)
			ms_relaxtemp(atoms.v, atype, atoms.natoms, atoms.t, atoms.m, tauQ, temperature);
		end
